...
export function Hero() {
  ...
  // GSAP animation for content sync pulse
  useEffect(() => {
  ...
  useGSAP(
    () => {
      if (prefersReducedMotion()) {
        gsap.set(
          '.hero-eyebrow, .hero-word, .hero-subtitle, .hero-cta, .hero-console, .hero-feature-badge',
      ...
      // Live MCP Console card entrance
      ...
      // Minimal feature badges stagger
      gsap.from('.hero-feature-badge', {
        opacity: 0,
        y: 12,
        duration: DUR.normal,
        ease: 'cg-out',
      ...
      case 'chatgpt':
        return (
          <div className="space-y-1 font-mono text-[11px] md:text-[12px] text-[var(--text-secondary)]">
            ...
            <div className="pl-8"><span className="text-[#ff7b72]">"user"</span>: <span className="text-[#a5d6ff]">"Prajyot Porje"</span>,</div>
      ...
      case 'claudecode':
        return (
          <div className="space-y-1 font-mono text-[11px] md:text-[12px] text-[var(--text-secondary)]">
            ...
            <div className="pl-4"><span className="text-[#ff7b72]">"working_dir"</span>: <span className="text-[#a5d6ff]">"/prajyot/projects/cg"</span>,</div>
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex min-h-[calc(100vh-60px)] w-full flex-col items-center justify-start overflow-hidden bg-[var(--bg)] px-[var(--space-6)] py-[var(--space-20)] md:py-[var(--space-24)]"
    >
      ...
      {/* Grid Pattern Behind Console — subtle */}
      <div
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center">
        ...
        <div className="hero-eyebrow mb-[var(--space-6)] flex items-center gap-[var(--space-2)] rounded-[var(--radius-full)] border border-[var(--border)] bg-[var(--badge-default-bg)] px-[var(--space-4)] py-[6px] shadow-[var(--shadow-xs)]">
          ...
          <span className="text-label text-[10px] text-[var(--text-secondary)] font-semibold tracking-[0.08em]">
            CROSS-AI CONTEXT PROTOCOL V1.0
          </span>
        </div>

        {/* S-tier display headline block */}
        <h1
          className="text-display-xxl text-[var(--text-primary)] tracking-[-0.03em] uppercase text-center max-w-4xl"
          style={{ perspective: '1000px', lineHeight: '0.95' }}
        >
          <span className="hero-word mr-[var(--space-4)] inline-block">
            Your
          </span>
          <span className="hero-word text-gradient-accent mr-[var(--space-4)] inline-block">
            Context.
          </span>
        ...
        <p className="hero-subtitle mt-[var(--space-6)] max-w-2xl text-body-lg text-[var(--text-secondary)] leading-relaxed font-normal">
          Build your personal context graph once. Every MCP-compatible AI client you work with—Claude, ChatGPT, Gemini, Cursor—seamlessly reads and updates the same source of truth.
        </p>

        {/* Action Buttons */}
        <div className="hero-cta mt-[var(--space-8)] flex flex-wrap items-center justify-center gap-[var(--space-4)]">
        ...
        <div className="hero-console mt-[var(--space-16)] w-full rounded-[var(--radius-lg)] border border-[var(--border)] bg-gradient-to-b from-[var(--card-raised)] to-[var(--card)] shadow-[var(--shadow-lg)] shadow-[var(--shadow-inset)] overflow-hidden text-left">
          {/* Header Bar */}
              ...
              <div className="flex flex-row lg:flex-col gap-1 overflow-x-auto pb-2 lg:pb-0 scrollbar-none">
                {aiClients.map(client => (
                  <button
                    ...
                    className={cn(
                      "w-auto lg:w-full text-left px-[var(--space-3)] py-[var(--space-3)] rounded-[var(--radius-md)] flex items-center justify-between transition-all duration-150 shrink-0",
        ...
        <div className="mt-[var(--space-12)] grid grid-cols-1 md:grid-cols-3 gap-[var(--space-6)] border-t border-[var(--border)] pt-[var(--space-8)] w-full">
          <div className="hero-feature-badge flex flex-col items-center md:items-start gap-1">
