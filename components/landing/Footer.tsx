  ...
  return (
    <footer className="relative border-t border-[var(--border)] bg-[var(--bg)] pt-20 pb-12 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1200px] px-[var(--space-6)] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left gap-6">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-3 transition-opacity duration-100 hover:opacity-90"
            >
            ...
            <div className="flex items-center gap-3.5 mt-2">
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="w-8 h-8 rounded-md border border-[var(--border)] bg-[var(--surface)] flex items-center justify-center text-[var(--text-secondary)] transition-colors hover:text-[var(--text-primary)] hover:border-[var(--border-strong)]"
                aria-label="GitHub Repository"
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current animate-in" aria-hidden="true" style={{ width: '15px', height: '15px' }}>
          ...
          <div className="lg:col-span-2 flex flex-col items-start text-left gap-4 lg:pl-6">
            <span className="text-label text-[10px] text-[var(--text-muted)] font-semibold tracking-[0.1em] uppercase">
              Platform
            </span>
      ...
      <div className="relative select-none pointer-events-none w-full flex justify-center py-6 overflow-hidden">
        <div 
          className="font-display font-bold text-[8.5vw] uppercase leading-none tracking-[0.15em] text-[var(--text-primary)] opacity-[0.02]"
          style={{
            fontSmooth: 'always',
